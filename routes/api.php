...
// Talent and Meeting Routes
Route::post('schedule-meeting', [App\Http\Controllers\Api\ScheduleMeetingController::class, 'store']);
Route::post('talent-applications', [App\Http\Controllers\Api\TalentApplicationController::class, 'store']);
Route::post('talent-requests', [App\Http\Controllers\Api\TalentRequestController::class, 'store']);

//Country
// Route::get('countries', [Api\CountriesController::class, 'index']);
Route::get('about_us', [App\Http\Controllers\Client\AboutUsController::class, 'index']);
Route::get('reminder', [App\Http\Controllers\Admin\NotificationController::class, 'reminder']);
