        ...
        <li class="language-nav">
          <div class="translate_wrapper">
            <div class="current_lang">
              <div class="lang"><i class="flag-icon flag-icon-<?php echo e((App::getLocale() == 'en') ? 'us' : 'eg'); ?>"></i><span class="lang-txt"><?php echo e(App::getLocale()); ?> </span></div>
            </div>
            <div class="more_lang">
...
<?php /**PATH C:\Users\HP\OneDrive\Desktop\_\codeing\work\hoem\remorra\pro\resources\views/admin/layout/header.blade.php ENDPATH**/ ?>